function Test_with_message_fails_if_function_does_not_throw()
...
function Test_without_message_fails_if_function_does_not_throw()
  call strager#assert#assert_throws(
    \ {-> v:none},
    \ '(some exception)',
  \ )
...
function Test_with_message_fails_if_function_does_not_throw_matching()
  call strager#assert#assert_throws(
...
function Test_without_message_fails_if_function_does_not_throw_matching()
  call strager#assert#assert_throws(
    \ {-> s:throw('A test error occurred!')},
    \ 'testing error',
  \ )
...
function Test_with_message_succeeds_if_function_throws_matching()
  call strager#assert#assert_throws(
    \ {-> s:throw('A test error occurred!')},
    \ 'test error',
    \ 'Function should throw the right error',
...
function Test_without_message_succeeds_if_function_throws_matching()
  call strager#assert#assert_throws(
    \ {-> s:throw('A test error occurred!')},
    \ 'test error',
  \ )
