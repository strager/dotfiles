...
function Test_move_command_without_argument_fails()
...
function Test_move_command_completes_relative_directory_names()
  call strager#move_file#register_command({'force': v:true})
  call s:set_up_test_project()
  edit old.txt
...
function Test_move_command_completes_relative_file_names()
  call strager#move_file#register_command({'force': v:true})
  call s:set_up_test_project()
  edit old.txt
...
function Test_move_command_expands_current_path_with_c_r_percent()
  call strager#move_file#register_command({'force': v:true})
  call s:set_up_test_project()
  edit old.txt
...
function Test_move_command_expands_env_vars()
  call strager#move_file#register_command({'force': v:true})
  call s:set_up_test_project()
  edit old.txt
...
function Test_move_command_changes_current_buffer()
  call strager#move_file#register_command({'force': v:true})
  call s:set_up_test_project()
  edit old.txt
  Move new.txt
...
function Test_move_absolute_creates_new_file()
  call s:set_up_test_project()
  edit old.txt
...
function Test_move_absolute_deletes_old_file()
  call s:set_up_test_project()
  edit old.txt
  call s:move_current_buffer_file(s:absolute_path('new.txt'))
...
function Test_move_absolute_changes_current_buffer()
  call s:set_up_test_project()
  edit old.txt
  call s:move_current_buffer_file(s:absolute_path('new.txt'))
...
function Test_move_relative_creates_new_file()
  call s:set_up_test_project()
  edit old.txt
...
function Test_move_relative_deletes_old_file()
  call s:set_up_test_project()
  edit old.txt
  call s:move_current_buffer_file('new.txt')
  call s:assert_file_does_not_exist('old.txt')
...
function Test_move_relative_changes_current_buffer()
  call s:set_up_test_project()
  edit old.txt
  call s:move_current_buffer_file('new.txt')
  call assert_equal('new.txt', bufname('%'))
...
function Test_move_unloads_old_file()
  call s:set_up_test_project()
  edit old.txt
  call s:move_current_buffer_file('new.txt')
...
function Test_move_then_move_back_restores_files()
  call s:set_up_test_project()
  edit old.txt
  call s:move_current_buffer_file('new.txt')
...
function Test_move_to_unwritable_directory_keeps_unsaved_changes_unsaved()
  call s:set_up_test_project()
  edit old.txt
...
function Test_move_relative_over_self_relative_does_not_delete_file()
  call s:set_up_test_project()
  edit old.txt
  call s:move_current_buffer_file('old.txt')
  call s:assert_file_exists('old.txt')
...
function Test_move_relative_over_self_absolute_does_not_delete_file()
  call s:set_up_test_project()
  edit old.txt
...
function Test_move_absolute_over_self_absolute_does_not_delete_file()
  call s:set_up_test_project()
...
function Test_move_absolute_over_self_relative_does_not_delete_file()
  call s:set_up_test_project()
  exec 'edit '.fnameescape('old.txt')
  call s:move_current_buffer_file('old.txt')
  call s:assert_file_exists('old.txt')
...
function Test_move_missing_file_fails()
  call s:set_up_test_project()
  edit old.txt
  call delete('old.txt')
...
function Test_move_over_symlink_to_self_fails()
  call s:set_up_test_project()
  edit old.txt
...
function Test_move_symlink_over_self_does_not_delete()
  call s:set_up_test_project()
  edit oldsymlink.txt
...
function Test_move_symlink_over_target_fails()
  call s:set_up_test_project()
  edit oldsymlink.txt
...
function Test_move_new_file_does_not_write()
  call s:set_up_test_project()
  edit from.txt
...
function Test_move_new_file_changes_current_buffer()
  call s:set_up_test_project()
  edit from.txt
  silent! normal itext goes here
...
function Test_move_new_file_then_write_saves_changes()
  call s:set_up_test_project()
  edit from.txt
  silent! normal itext goes here
...
function Test_move_to_opened_new_file_fails()
  call s:set_up_test_project()
  edit new.txt
  split old.txt
...
function Test_move_to_opened_file_fails()
  call s:set_up_test_project()
  edit new.txt
  write
  split old.txt
...
function Test_move_to_opened_symlink_fails()
  call s:set_up_test_project()
  edit oldsymlink.txt
  write
  split README.md
...
function Test_move_to_symlink_of_opened_file_fails()
  call s:set_up_test_project()
  edit old.txt
  write
  split README.md
...
function Test_move_to_opened_symlink_target_fails()
  call s:set_up_test_project()
  edit oldsymlink.txt
  write
  split README.md
...
function Test_move_to_opened_file_with_percent_name_fails()
  call s:set_up_test_project()
  edit \%
  write
  split old.txt
...
function Test_move_to_file_with_same_name_as_nofile_buffer_file()
  call s:set_up_test_project()
  edit new.txt
...
function Test_move_updates_other_windows()
  call s:set_up_test_project()
  edit old.txt
...
function Test_move_keeps_unsaved_changes_unsaved()
  call s:set_up_test_project()
  edit old.txt
  silent! normal oGreetings.
...
function Test_move_with_unsaved_changes_then_write_saves_changes()
  call s:set_up_test_project()
  edit old.txt
  silent! normal oGreetings.
...
function Test_move_preserves_file_permissions()
...
function Test_move_directory_fails()
  call s:set_up_test_project()
  edit emptydir
...
function Test_move_to_directory_fails()
  call s:set_up_test_project()
  edit old.txt
...
function Test_move_in_unnamed_buffer_fails()
  call s:set_up_test_project()
  new
...
function Test_move_in_quickfix_buffer_fails()
  call s:set_up_test_project()
  edit old.txt
  copen
...
function Test_move_in_terminal_buffer_fails()
  call s:set_up_test_project()
  edit old.txt
  terminal
...
function Test_move_to_file_with_star_with_related_buffers_open()
...
function Test_move_to_file_with_base_name_open()
...
function Test_move_to_prefix_of_open_file()
  " Make sure the new path isn't treated as a substring matching open buffers.
  call s:set_up_test_project()
  edit README.md
  split old.txt
...
function Test_move_to_file_containing_nomagic_pattern()
...
function Test_move_to_backslash_with_dollar_file_open()
  call s:set_up_test_project()
  edit $
  split old.txt
...
function Test_move_updates_quickfix_list()
  call s:set_up_test_project()
  edit README.md
...
function Test_move_shows_new_file_info_in_status_line()
  call s:set_up_test_project()
  edit old.txt
  set ruler
...
function Test_move_shows_new_file_info_in_status_line_noruler()
  call s:set_up_test_project()
  edit old.txt
  set noruler
...
function Test_move_with_unsaved_changes_shows_new_file_info_in_status_line_noruler()
...
function s:assert_file_exists(path)
  call assert_true(
...
function s:assert_directory_exists(path)
...
function s:assert_file_does_not_exist(path)
  call assert_false(
    \ strager#file#file_exists_case_sensitive(a:path),
