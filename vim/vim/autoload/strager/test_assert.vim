...
function Test_assert_contains_passes_if_list_contains_string_value_once()
...
function Test_assert_contains_fails_if_list_is_empty()
  call strager#assert#assert_contains('hello', [])
  let l:error_messages = strager#assert#take_assertion_failure_messages()
  call assert_equal(["'hello' should be in []"], l:error_messages)
endfunction

function Test_assert_contains_fails_if_list_contains_needle_wrapped_in_list()
  call strager#assert#assert_contains('hello', [['hello']])
  let l:error_messages = strager#assert#take_assertion_failure_messages()
  call assert_equal(["'hello' should be in [['hello']]"], l:error_messages)
endfunction

function Test_assert_contains_fails_if_list_contains_equal_value_with_different_type()
  " Check sanity.
