function Test_syntax_check_aliases_of_empty_string()
  let l:aliases = s:parse_syntax_aliases([''])
  call assert_equal({}, l:aliases)
endfunction

function Test_syntax_check_aliases_of_one_simple_line()
  let l:aliases = s:parse_syntax_aliases([
...
function Test_syntax_check_aliases_of_one_line_with_surrounding_noise()
  let l:aliases = s:parse_syntax_aliases([
...
function Test_parse_syntax_check_alias_with_no_groups()
  let l:issues = []
...
function Test_syntax_check_aliases_of_one_none_alias()
  let l:aliases = s:parse_syntax_aliases([
    \ 'CHECK-ALIAS: / <none>',
  \ ])
...
function Test_syntax_check_aliases_of_one_ignore_alias()
  let l:aliases = s:parse_syntax_aliases([
...
function Test_parse_syntax_check_alias_with_space_alias_code()
  let l:issues = []
  let l:aliases = s:parse_syntax_aliases([
...
function Test_parse_syntax_check_alias_without_alias_code()
  let l:issues = []
  let l:aliases = s:parse_syntax_aliases([
    \ 'CHECK-ALIAS:vimLineComment',
  \ ], l:issues)
...
function Test_parse_syntax_check_alias_with_multiple_choices()
  let l:issues = []
  let l:aliases = s:parse_syntax_aliases([
...
function Test_parse_syntax_check_alias_with_multiple_choices_including_none()
  let l:issues = []
  let l:aliases = s:parse_syntax_aliases([
...
function Test_parse_syntax_check_alias_with_multiple_issues()
  let l:issues = []
  let l:aliases = s:parse_syntax_aliases([
    \ '',
    \ '// CHECK-ALIAS:',
...
function Test_parse_syntax_check_alias_with_extra_whitespace()
  let l:aliases = s:parse_syntax_aliases([
    \ '  CHECK-ALIAS:  c   vimLineComment   ',
  \ ])
  call assert_equal({'c': ['vimLineComment']}, l:aliases)
...
function Test_syntax_checks_of_empty_string()
  let l:checks = s:parse_syntax_checks([''])
  call assert_equal([], l:checks)
endfunction

function Test_syntax_checks_of_one_empty_suffix_line()
...
function Test_syntax_check_line_numbers_of_many_empty_suffix_line()
  let l:checks = s:parse_syntax_checks([
    \ '',
    \ ':CHECK-NEXT-LINE',
    \ '',
...
function Test_syntax_checks_of_one_suffix_line_with_characters()
...
function Test_syntax_issue_quickfix_item_severity()
  let l:item = s:get_quickfix_item_for_issue(
    \ s:syntax_issue(5, 3, ''),
  \ )
...
function Test_syntax_issue_quickfix_item_message()
  let l:item = s:get_quickfix_item_for_issue(
...
function Test_syntax_item_from_current_window_without_syntax()
  new
  silent! normal ihello world
  call assert_equal(v:none, s:syntax_item_from_current_window(1, 1))
endfunction

function Test_syntax_item_from_current_window_with_vim_syntax()
  new
  set filetype=vim
  syntax on
  set paste
...
function s:get_quickfix_item_for_issue(issue)
  return strager#check_syntax_internal#get_quickfix_item_for_issue(a:issue)
endfunction

function s:parse_syntax_aliases(lines, ...)
...
function s:parse_syntax_checks(lines)
  return strager#check_syntax_internal#parse_syntax_checks(a:lines)
endfunction

function s:syntax_item_from_current_window(line, column)
