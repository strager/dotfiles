function Test_new_unnamed_buffer_is_new()
  new
  call assert_true(strager#buffer#is_current_buffer_new())
endfunction

function Test_new_named_buffer_is_new()
...
function Test_new_file_buffer_is_new()
  let l:dir_path = strager#file#make_directory_with_files([])
  exec 'edit '.fnameescape(strager#path#join([l:dir_path, 'missingfile.txt']))
  call assert_true(strager#buffer#is_current_buffer_new())
endfunction

function Test_existing_file_is_not_new()
...
function Test_checking_buffer_newness_does_not_add_message()
  let l:dir_path = strager#file#make_directory_with_files(['file.txt'])
  exec 'edit '.fnameescape(strager#path#join([l:dir_path, 'file.txt']))
...
function Test_no_buffer_number_for_nonexistant_name()
  %bwipeout!
  call assert_equal(-1, strager#buffer#buffer_number_by_name('somebuffer'))
endfunction

function Test_absolute_buffer_number_by_absolute_file_path()
  %bwipeout!
  let l:dir_path = strager#file#make_directory_with_files(['file.txt'])
...
function Test_relative_buffer_number_by_absolute_file_path()
  %bwipeout!
  let l:dir_path = strager#file#make_directory_with_files(['file.txt'])
...
function Test_absolute_buffer_number_by_relative_file_path()
  %bwipeout!
  let l:dir_path = strager#file#make_directory_with_files(['file.txt'])
  exec 'cd '.fnameescape(l:dir_path)
  exec 'edit '.fnameescape(strager#path#join([l:dir_path, 'file.txt']))
...
function Test_relative_buffer_number_by_relative_file_path()
  %bwipeout!
  let l:dir_path = strager#file#make_directory_with_files(['file.txt'])
  exec 'cd '.fnameescape(l:dir_path)
  edit file.txt
...
function Test_absolute_buffer_number_by_relative_file_path_with_similarly_named_buffers()
  %bwipeout!
  let l:dir_path = strager#file#make_directory_with_files([
    \ 'dir/file.txt',
    \ 'file.txt',
...
function Test_relative_buffer_number_by_relative_file_path_with_similarly_named_buffers()
  %bwipeout!
  let l:dir_path = strager#file#make_directory_with_files([
    \ 'dir/file.txt',
    \ 'file.txt',
...
function Test_buffer_number_by_file_name_incomplete()
  %bwipeout!
...
function Test_buffer_number_by_file_name_does_not_glob()
  %bwipeout!
  let l:dir_path = strager#file#make_directory_with_files(['file.txt'])
  exec 'cd '.fnameescape(l:dir_path)
  edit file.txt
...
function Test_buffer_number_by_file_name_matches_with_glob()
  %bwipeout!
...
function Test_buffer_number_by_file_name_matches_one_with_glob()
  %bwipeout!
  let l:dir_path = strager#file#make_directory_with_files([
    \ 'fi*.txt',
    \ 'file.txt',
...
function Test_buffer_number_by_percent_file_name()
  %bwipeout!
...
function Test_buffer_number_by_hash_file_name()
  %bwipeout!
  let l:dir_path = strager#file#make_directory_with_files(['#', 'other.txt'])
  exec 'cd '.fnameescape(l:dir_path)
  edit \#
...
function Test_buffer_number_by_dollar_file_name()
  %bwipeout!
  let l:dir_path = strager#file#make_directory_with_files(['$', 'other.txt'])
  exec 'cd '.fnameescape(l:dir_path)
  edit \$
...
function Test_buffer_number_by_empty_name()
  %bwipeout!
  let l:dir_path = strager#file#make_directory_with_files(['file.txt'])
  exec 'cd '.fnameescape(l:dir_path)
  edit file.txt
