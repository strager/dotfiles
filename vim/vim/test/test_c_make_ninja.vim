...
function! Test_ninja_cd_compile_error_from_empty_buffer() abort
  call s:set_up()
  set makeprg=ninja
...
function! Test_ninja_cd_compile_error_from_source_buffer() abort
  call s:set_up()
  set makeprg=ninja
  cd test_c_make_ninja_helper
  edit program.c
...
function! Test_ninja_relative_compile_error_from_empty_buffer() abort
  call s:set_up()
...
function! Test_ninja_relative_compile_error_from_source_buffer() abort
  call s:set_up()
  set makeprg=ninja\ -C\ test_c_make_ninja_helper
...
function! s:assert_cursor_should_have_jumped_to_error() abort
