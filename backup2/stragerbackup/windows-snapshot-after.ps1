# This is a after-folder-action script for Kopia.
#
# This script cleans up the Windows shadow copy of the filesystem created by windows-snapshot-before.ps1.
#
# Original source: https://kopia.io/docs/advanced/actions/#examples
