...
def main() -> None:
    ...
    command = ["kopia", "repository", "sync-to", "sftp", f"--path={site.nas_sftp_directory}", "--host=strager-nas", "--username=strager", "--keyfile", site.ssh_key_file, "--known-hosts", site.ssh_known_hosts_file,]
